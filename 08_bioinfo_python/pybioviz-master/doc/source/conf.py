...
latex_documents = [
  ('index', 'pybioviz.tex', u'pybioviz Documentation',
...
man_pages = [
    ('index', 'pybioviz', u'pybioviz Documentation',
     [u'Damien Farrell'], 1)
]
...
texinfo_documents = [
  ('index', 'pybioviz', u'pybioviz Documentation',
   u'Damien Farrell', 'pybioviz', 'One line description of project.',
   'Miscellaneous'),
]
